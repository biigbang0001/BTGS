...
const char * const BITCOIN_CONF_FILENAME = "btgs.conf";
...
{
    // Windows: %LOCALAPPDATA%\BTGS
    // macOS: ~/Library/Application Support/BTGS
    // Unix-like: ~/.btgs
#ifdef WIN32
    return GetSpecialFolderPath(CSIDL_LOCAL_APPDATA) / "BTGS";
#else
    fs::path pathRet;
...
#ifdef __APPLE__
    return pathRet / "Library/Application Support/BTGS";
#else
    return pathRet / ".btgs";
#endif
#endif
